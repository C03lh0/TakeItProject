...
namespace TakeIt.UWP.Views
{
    ...
    /// </summary>
    public sealed partial class BorrowedItemFormView : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            var itemID = (int)((Object[])e.Parameter)[1];
            AppShell currentAppShell = (AppShell)((Object[])e.Parameter)[0];
            DataContext = new BorrowedItemFormViewModel(currentAppShell, itemID);
        }
    }
}
